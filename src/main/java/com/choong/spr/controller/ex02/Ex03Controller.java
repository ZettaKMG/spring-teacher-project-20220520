...
public class Ex03Controller {
	...
	public String method04() {
		System.out.println("ex03/sub04 작동 중@@@");
	...
	public String method05() {
		System.out.println("ex03/sub05 get 방식 정상 작동@!@!@!");
	...
	public String method06() {
		System.out.println("ex03/sub06 post 방식 정상 작동!@!@!@");
...
//	@RequestMapping(method = RequestMethod.DELETE, value = "sub07")
	...
	public String method07() {
		System.out.println("ex03/sub07 delete 방식 정상 작동%%%");
...
//	@RequestMapping(method = RequestMethod.PUT, value = "sub08")
	...
	public String method08() {
		System.out.println("ex03/sub08 put 방식 정상 작동$$$");
	...
	@PostMapping("sub11")
	public String method11(Book book) { // void 타입으로도 가능
	...
	@PostMapping("sub13")
	public String method13(String title, String writer) {
		System.out.println("title: " + title);
		System.out.println("writer: " + writer);
	...
	@PostMapping("sub14")
	public void method14(Book book) {
		System.out.println(book);
	}
}
